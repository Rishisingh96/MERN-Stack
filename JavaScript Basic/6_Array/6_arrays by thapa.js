...
// syntax
// console.log(numbers.indexOf(5, 7))  //-1
...
// console.log(result1);
// const result = numbers.indexOf(6, 5);  //search first
// const result = numbers.lastIndexOf(6, 5);  //search to backward
// console.log(result);
...
// const indexTodupdate = months.indexOf("march");
// console.log(indexTodupdate);
// months.splice(indexTodupdate, 1, "March");
// console.log(months)
