...
// const date1 = new Date(2025, 13);
// console.log(date1);  //Sun Feb 01 2026 00:00:00 GMT+0530 (India Standard Time)

// ? 4: new Date(year, month, day): Creates a Date object with the specified year, month, and day.
// const date2 = new Date(2024, 1, 19);
// console.log(date2); ////2024-02-18T18:30:00.000Z because month start form 0 - 11
...
// console.log(date4);  //Mon Feb 19 2024 10:44:00 GMT+0530 (India Standard Time)
...
// // const milliseconds = 1746736068250; // Example milliseconds
...
// Find Milliseconds -
// const curMilliSeconds = new Date().getTime();
// console.log(curMilliSeconds); // 1746736068250

// Find Time from Milliseconds -
// const milliseconds = 1746736068250;
// const dateFromMilliseconds = new Date(milliseconds);
// console.log(dateFromMilliseconds); //2025-05-08T20:27:48.250Z
...
// console.log(year);
// console.log(month); //4
// console.log(day); //5 because Sunday start 0 - 6 Today is Friday
...
const date = new Date(); //2025-05-08T20:53:04.497Z
console.log(date);
