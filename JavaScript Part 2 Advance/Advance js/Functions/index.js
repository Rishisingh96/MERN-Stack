...
console.log("Addition: " + mathOperation(10, 5, add)); // Output: Addition: 15
console.log("Subtraction: " + mathOperation(10, 5, subtract)); // Output: Subtraction: 5
console.log("Multiplication: " + mathOperation(10, 5, multiply)); // Output: Multiplication: 50
console.log("Division: " + mathOperation(10, 5, divide)); // Output: Division: 2